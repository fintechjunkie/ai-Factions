...
export const SCENARIOS: Scenario[] = [
  {
    ...
    plainDescription:
      "The cities that won are extraordinary — gleaming, fast, and almost frictionless if you have the capital to live in them. AI handles the legal research, the financial analysis, the creative briefs, the customer service, the logistics, the first drafts of everything. For the people who own the systems, or who build on top of them, or who simply got in early, life is better than anything their parents imagined. For everyone else, the math stopped working sometime in the late 2020s and never recovered. Entry-level jobs disappeared first, then middle management, then whole professional tiers. The unemployment numbers look fine because the definition of 'employed' quietly shifted. The stock market keeps hitting records. There are serious conversations in some cities about whether money itself still means what it used to. Nobody in power is particularly worried — and that is the thing that worries everyone else.",
    narrative: [
  ...
  },
  {
    ...
    plainDescription:
      "This is a world that fought back, and it shows — in the contracts, the protected industries, the legislative wins, the ongoing investigations into what the AI companies knew and when. The revolt was real, and it changed things: workers in certain sectors have genuine protections, a few robot taxes are funding retraining programs that mostly work, and the billionaires of the 2020s operate in a political climate where they have to watch their words in ways they didn't before. But the technology didn't stop, and the protection is uneven — strong where unions were already strong, weak everywhere they weren't. It feels like a negotiated settlement that nobody loves: the tech sector is frustrated and partially offshored, labor is protected but anxious, and everyone senses that the underlying forces were only slowed, not resolved. The fight became the defining story of the era. It's still being fought.",
    narrative: [
  ...
  },
  {
    ...
    plainDescription:
      "Nobody won, and it shows in everything. Your experience of AI — what it can do to you, what you can do with it, who is liable when it fails — depends entirely on where you live, what sector you work in, and which of thirty overlapping legal regimes happens to apply to your situation. The technology deployed anyway. The wealth concentrated anyway. But without anyone governing it coherently, the world feels like a city where the infrastructure was built by a dozen different contractors who never spoke to each other: functional in patches, broken in ways nobody has the authority to fix, and increasingly difficult to navigate without a specialist. The EU became the closest thing to a global standard, which means American companies answer to Brussels more than Washington. The old institutions still exist but their authority is contested. People have mostly adapted. That adaptation looks different depending on which side of the line you ended up on — and the lines keep moving.",
    narrative: [
